...
# Created: Wed Nov 28 16:52:54 PST 2012
#
#/ usage: github:delete-web-hook  --owner <>  --repository <> [ --api-url <https://api.github.com>] [ --authorization-file <$HOME/.rerun/github.authorization>]  --web-hook-url <> 
