...
# Created: Tue Nov 20 16:17:27 PST 2012
#
#/ usage: github:delete-repo-deploy-keys  --owner <>  --repository <> [ --title <${USER}@${HOSTNAME}>] [ --api-url <https://api.github.com>] [ --authorization-file <$HOME/.rerun/github.authorization>] 
