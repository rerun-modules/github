...
# Created: Tue Nov 20 16:17:00 PST 2012
#
#/ usage: github:create-repo-deploy-key  --owner <>  --repository <> [ --title <${USER}@${HOSTNAME}>] [ --key-file <$HOME/.ssh/id_dsa.pub>] [ --api-url <https://api.github.com>] [ --authorization-file <$HOME/.rerun/github.authorization>] 
